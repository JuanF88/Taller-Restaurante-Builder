...
public class ItalianDishBuilder extends DishBuilder {
  ...
  @Override
    ...
    public DishBuilder setCore() {
        disItalian.setBase(read(bases, "Base"));
        return this;
    }

    @Override
    public boolean addPart() {
        disItalian.addOption(read(options, "Opcion"));
    ...
    public DishBuilder setSize() {
      ...
      if(tamano.equals("F")) disItalian.setSize(Size.FAMILY);
      if(tamano.equals("D")) disItalian.setSize(Size.DOUBLE);
      if(tamano.equals("P")) disItalian.setSize(Size.PERSONAL);
      return this;
    }
